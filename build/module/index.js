...
var ReactTagInput = (function (_super) {
    ...
    function ReactTagInput() {
        ...
        _this.onInputKeyDown = function (e) {
            ...
            var _a = _this.props, validator = _a.validator, removeOnBackspace = _a.removeOnBackspace;
             ...
             const suggest = _a.suggestions.filter(function(item) { return queryRegExp.test(item); })
             // console.log(suggest)
             _this.setState({ suggestions: suggest });
    ...
    ReactTagInput.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classSelectors.wrapper },
            ...
            showInput &&
                React.createElement("input", { ref: this.inputRef, value: input, id: "autoSearch" , className: classSelectors.input, placeholder: placeholder || "Type and press enter", onChange: this.onInputChange, onKeyDown: this.onInputKeyDown })
